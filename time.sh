...
CONFIG5="--nthreads 1 --enable-cuda --enable-gpu-cache"
CONFIG6="--nthreads 4 --enable-cuda --enable-gpu-cache"
CONFIG7="--nthreads 4 --enable-avx --enable-mpi --mpi-npernode 3"
CONFIG8="--nthreads 4 --enable-cuda --enable-gpu-cache --enable-mpi --mpi-npernode 3"
...
echo "SMC^2"
echo "-----"
echo -n "1: "; eval "libbi sample @posterior_smc2.conf $CONFIG_COMMON $CONFIG1 --disable-gpu-cache --nsamples 192 2> /dev/null"
echo -n "2: "; eval "libbi sample @posterior_smc2.conf $CONFIG_COMMON $CONFIG2 --disable-gpu-cache --nsamples 192 2> /dev/null"
echo -n "3: "; eval "libbi sample @posterior_smc2.conf $CONFIG_COMMON $CONFIG3 --disable-gpu-cache --nsamples 192 2> /dev/null"
echo -n "4: "; eval "libbi sample @posterior_smc2.conf $CONFIG_COMMON $CONFIG4 --disable-gpu-cache --nsamples 192 2> /dev/null"
echo -n "5: "; eval "libbi sample @posterior_smc2.conf $CONFIG_COMMON $CONFIG5 --disable-gpu-cache --nsamples 192 2> /dev/null"
echo -n "6: "; eval "libbi sample @posterior_smc2.conf $CONFIG_COMMON $CONFIG6 --disable-gpu-cache --nsamples 192 2> /dev/null"
echo -n "7: "; eval "libbi sample @posterior_smc2.conf $CONFIG_COMMON $CONFIG7 --disable-gpu-cache --nsamples 192 2> /dev/null"
echo -n "8: "; eval "libbi sample @posterior_smc2.conf $CONFIG_COMMON $CONFIG8 --disable-gpu-cache --nsamples 192 2> /dev/null"
echo
